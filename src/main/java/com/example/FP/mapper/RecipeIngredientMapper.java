...
public class RecipeIngredientMapper {
    public static RecipeIngredient toEntity(RecipeIngredientDto recipeIngredientDto){
        RecipeIngredient recipeIngredient = new RecipeIngredient(recipeIngredientDto.getRecipe_ingredient_qty(), recipeIngredientDto.getRecipe_ingredient_need(),recipeIngredientDto.getRecipe_ingredient_recipe(),recipeIngredientDto.getRecipe_ingredient_ingredient());
